...
// 静态线程+信号量同步+三重循环全部纳入实现的线程函数
void *threadFuncStaticBody(void *param)
{
...
// 静态线程+信号量同步+三重循环全部纳入实现的多线程优化并行算法
